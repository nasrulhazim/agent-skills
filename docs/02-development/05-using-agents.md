...
The 16 agents cover every SDLC phase:
...
| Implementation | laravel-developer | Features end-to-end with tests |
...
| Security | security-analyst | Defensive audits, advisories, incident investigation |
...
- **Feature:** business-analyst (requirements) →
  software-architect (design) → laravel-developer
  (build) → code-reviewer + qa-engineer (verify) →
